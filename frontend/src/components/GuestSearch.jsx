  ...
  return (
    <form onSubmit={handleSubmit} className="flex items-center text-primary-800 space-x-2">
      ...
      <button
        type="submit"
        disabled={loading}
        className="flex items-center justify-center px-3 py-2 bg-primary-700 text-white rounded-lg hover:bg-primary-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
