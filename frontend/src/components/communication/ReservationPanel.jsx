  ...
  if (!thread) {
    return (
      <div className="h-full p-4">
        <h3 className="text-lg font-semibold text-primary-900 mb-4">Reservation Details</h3>
        <div className="text-center text-primary-500 py-8">
          <Home className="w-12 h-12 mx-auto mb-3 text-primary-300" />
    ...
    <div className="h-full p-4 overflow-y-auto">
      ...
      {!reservation ? (
        ...
        <div className="space-y-6">
          ...
          {/* Reservation Status */}
          <div>
            <h4 className="text-sm font-medium text-primary-900 mb-3">Status</h4>
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
          ...
          {/* Quick Actions */}
          <div>
            <h4 className="text-sm font-medium text-primary-900 mb-3">Quick Actions</h4>
            <div className="space-y-2">
              <button className="w-full text-left px-3 py-2 text-sm text-primary-700 hover:bg-primary-100 rounded-md">
