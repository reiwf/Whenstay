    ...
    <div className="h-full flex flex-col bg-primary-50">
      ...
      <div className="bg-white border-b border-primary-200 px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={refresh}
            disabled={refreshing}                         // only lock button during refresh
        ...
        <div className="flex items-end space-x-3">
          <div className="flex-1">
            <textarea
              ...
              className="w-full resize-none border border-primary-300 rounded-lg px-3 py-2 text-sm focus:ring-1 focus:ring-primary-500 focus:border-primary-500 max-h-32"
              rows="1"
              disabled={sending}
            />
          ...
          <button
            ...
            className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-primary-600 text-white hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {sending ? (
