...
export default function CleanerLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.email === 'cleaner@example.com' && formData.password === 'cleaner123') {
        // Store auth info
        localStorage.setItem('userRole', 'cleaner')
        localStorage.setItem('authToken', 'mock-cleaner-token')
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Access your cleaning task dashboard
        </p>
      </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <p className="text-sm text-blue-700">
                <strong>Email:</strong> cleaner@example.com<br />
                <strong>Password:</strong> cleaner123
              </p>
            </div>
          </div>
