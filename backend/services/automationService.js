  ...
  async buildTemplateVariables(reservation) {
    try {
      ...
      const variables = {
        ...
        guest_name: `${reservation.booking_name || reservation.bookingName || ''} ${reservation.booking_lastname || reservation.bookingLastname || ''}`.trim() || 'Guest',
        guest_first_name: reservation.booking_name || reservation.bookingName || 'Guest',
